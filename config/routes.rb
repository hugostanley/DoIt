...
Rails.application.routes.draw do
  ...
  post "user/login", to: "sessions#create", as: "sessions"
  delete "user/signout", to: "sessions#destroy", as: "user_signout"
  ...
  post "user/search", to: "users#search_submit", as: "users_search_submit"
